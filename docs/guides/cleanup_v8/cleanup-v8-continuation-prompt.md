...
- **Phase 3**: IN PROGRESS. P3.0 complete (docs reorg + ADR normalization + path rewrites); P3.1 complete (`docs/guides/cleanup_v8/docs_inventory.md` — 44 DEV_PITFALLS + 19 AGENTS sections mapped to destinations); P3.2/P3.3 next.
...
1. Confirm or adjust the P3.2 target structure (proposed layout in `cleanup-v8-tasks.md` §P3.2). No new files are created during P3.2 — it is a planning/sign-off step only.
2. Execute P3.3 migration: 29 commits, one per destination file, following the commit sequence in `docs/guides/cleanup_v8/docs_inventory.md` §4.
