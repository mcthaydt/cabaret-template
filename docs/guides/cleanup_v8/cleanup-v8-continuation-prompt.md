...
- **Phase 3**: IN PROGRESS. P3.0 complete (docs reorg + ADR normalization + path rewrites); P3.1 complete (`fce9f326`, inventory maps 44 DEV_PITFALLS + 19 AGENTS sections); P3.2 target structure confirmed with style guard green; P3.3 next.
...
1. Execute P3.3 migration: 29 commits, one per destination file, following the commit sequence in `docs/guides/cleanup_v8/docs_inventory.md` §4.
2. Start with `docs/guides/pitfalls/GODOT_ENGINE.md` (DEV_PITFALLS §1–5), then proceed through `GDSCRIPT_4_6.md`, `ECS.md`, `STATE.md`, `MOBILE.md`, and `TESTING.md`.
