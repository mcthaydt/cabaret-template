...
**Latest planning note (March 15, 2026):** Phase 3 reset — OTS Phase 3B landed (`U_VCamModeEvaluator` OTS branch + `cfg_default_ots.tres` + evaluator/resource coverage). Phase 3C game feel (collision avoidance, shoulder sway, landing camera response) is now the active target.
