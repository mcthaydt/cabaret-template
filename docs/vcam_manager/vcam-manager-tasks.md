...
**Latest planning note (March 15, 2026):** Phase 3 reset — OTS Phase 3C1 landed (`S_VCamSystem` OTS collision avoidance + per-vCam collision dynamics state + coverage in `test_vcam_system`). Next active target is 3C2 shoulder sway, then 3C3 landing camera response.
