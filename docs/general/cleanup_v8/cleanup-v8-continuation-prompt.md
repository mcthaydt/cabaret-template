...
**Status**: Phase 1 in progress. P1.1 is complete; P1.2 Commit 1-4 are complete (`b5962d32`, `e07a933a`, `a70032dd`, `784aede9`).
**Next Task**: P1.2 Commit 5 (RED) — write `tests/unit/ai/bt/test_rs_bt_utility_selector.gd`.
...
2. Implement **P1.2 Commit 5 (RED)** — add `tests/unit/ai/bt/test_rs_bt_utility_selector.gd`.
3. Implement **P1.2 Commit 6 (GREEN)** — add `scripts/resources/bt/rs_bt_utility_selector.gd`.
