...
**Status**: Phase 1 in progress. P1.1–P1.6 complete; P1.6b in progress (Commit 1 RED `a98fd907`, Commit 2 GREEN `08f2aaf4`, Commit 3 RED `0c196e7d`). P1.6 commits: `f46f1fa3`, `5967661e`. Full commit list: `b5962d32`, `e07a933a`, `a70032dd`, `784aede9`, `e84e2890`, `79344746`, `8c163ae0`, `5051a2c4`, `fa7fc071`, `aa083186`, `7a3e936f`, `6ad6e79c`, `677003b4`, `b5eafe91`, `488807d2`, `cf80eb4f`, `4069c08a`, `165d93c4`, `4ea75032`, `5e3bdf5e`, `a2c54f7b`, `f46f1fa3`, `5967661e`, `a98fd907`, `08f2aaf4`, `0c196e7d`.
**Next Task**: P1.6b Commit 4 (GREEN) — implement `scripts/utils/ai/u_ai_world_state_builder.gd`.
...
- **Phase 1**: IN PROGRESS.
  ...
  - **Verification state**:
    ...
    - New P1.6b world-state-builder contract tests are red for expected missing-script reason (`tests/unit/ai/bt/test_u_ai_world_state_builder.gd` expects `scripts/utils/ai/u_ai_world_state_builder.gd`).
    ...
    - Full suite is green on `cleanup-v8` (`tools/run_gut_suite.sh`: 4522 passing / 8 pending / 0 failing).
...
2. Implement **P1.6b Commit 4 (GREEN)** — add `scripts/utils/ai/u_ai_world_state_builder.gd`.
