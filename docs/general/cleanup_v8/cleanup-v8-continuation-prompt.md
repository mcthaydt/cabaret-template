...
- **Phase 2**: IN PROGRESS. P2.1 complete (audit doc + grep evidence baseline captured, 2026-04-23). P2.2 complete (`93f10490`, `8f4ce20b`). P2.3 in progress (manager-side complete; ECS core systems migrated through `07892b12`). P2.4 pending.
...
1. Continue P2.3 migration with remaining ECS system-helper bare-print sites from the P2.1 audit list (`u_vcam_debug.gd`, `u_vcam_look_input.gd`, `u_vcam_look_spring.gd`).
