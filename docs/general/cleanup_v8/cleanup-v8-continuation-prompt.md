...
**Next Task**: P1.9 Commit 5 (RED+GREEN) — migrate sentry, patrol_drone, and guide_prism BT parity/resources.
...
- **Phase 1**: IN PROGRESS.
  ...
  - **Verification state**:
    ...
    - Current full-suite check after P1.9 Commit 4 reports expected pre-P1.10 migration fallout (`4470` passing / `100` failing / `8` pending).
...
2. Implement **P1.9 Commit 5 (RED+GREEN)** — sentry, patrol_drone, guide_prism BT parity/resources.
3. Continue P1.9 creature migrations in order, then run the P1.9 planner-showcase Commit 6.
