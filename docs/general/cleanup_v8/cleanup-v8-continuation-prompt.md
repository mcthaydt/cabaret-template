...
- **Phase 1**: IN PROGRESS.
  ...
  - **Verification state**:
    ...
    - Full suite is green on `cleanup-v8` (`tools/run_gut_suite.sh`: 4531 passing / 8 pending / 0 failing).
...
2. Implement **P1.6b Commit 8 (GREEN)** — add `scripts/utils/ai/u_bt_planner_search.gd`.
