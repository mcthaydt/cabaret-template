...
- **Phase 2**: IN PROGRESS. P2.1 complete (audit doc + grep evidence baseline captured, 2026-04-23). P2.2 complete (`93f10490`, `8f4ce20b`). P2.3–P2.4 pending.
...
1. Start P2.3 migration with manager-side bare-print sites from the P2.1 audit list (`m_save_manager.gd`, `m_vcam_manager.gd`, `m_run_coordinator_manager.gd`, `m_scene_manager.gd`, `m_scene_director_manager.gd`, `scripts/managers/helpers/u_vcam_collision_detector.gd`).
