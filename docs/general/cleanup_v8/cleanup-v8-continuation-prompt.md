...
**Status**: Phase 1 in progress. P1.1–P1.5 complete; P1.6 next. P1.5 commits: `488807d2`, `cf80eb4f`, `4069c08a`, `165d93c4`, `4ea75032`, `5e3bdf5e`, `a2c54f7b`. Full commit list: `b5962d32`, `e07a933a`, `a70032dd`, `784aede9`, `e84e2890`, `79344746`, `8c163ae0`, `5051a2c4`, `fa7fc071`, `aa083186`, `7a3e936f`, `6ad6e79c`, `677003b4`, `b5eafe91`, `488807d2`, `cf80eb4f`, `4069c08a`, `165d93c4`, `4ea75032`, `5e3bdf5e`, `a2c54f7b`.
**Next Task**: P1.6 Commit 1 (RED) — write `tests/unit/ai/bt/test_u_bt_runner.gd`.
...
- **Phase 1**: IN PROGRESS.
  ...
  - **Verification state**:
    ...
    - Full suite is green on `cleanup-v8` (`tools/run_gut_suite.sh`: 4512 passing / 8 pending / 0 failing).
...
2. Implement **P1.6 Commit 1 (RED)** — add `tests/unit/ai/bt/test_u_bt_runner.gd`.
3. Implement **P1.6 Commit 2 (GREEN)** — add `scripts/utils/bt/u_bt_runner.gd`.
4. Continue through P1.6b planning milestones in order.
