...
**Next Task**: P1.9b manual woods parity gate — launch `gameplay_ai_woods.tscn` in editor, verify builder harvest→deposit→build loop within ~60s. Then proceed to P1.10 legacy deletions.
