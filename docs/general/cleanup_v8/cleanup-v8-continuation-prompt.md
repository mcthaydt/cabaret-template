...
- **Phase 2**: IN PROGRESS. P2.1 complete (audit doc + grep evidence baseline captured, 2026-04-23). P2.2 complete (`93f10490`, `8f4ce20b`). P2.3 in progress (manager-side + first ECS-system files complete: `9b91b977`, `c4438ff0`, `34850084`, `19307d8b`). P2.4 pending.
...
1. Continue P2.3 migration with remaining ECS-system bare-print sites from the P2.1 audit list (manager-side set is complete; `s_victory_handler_system.gd` and `s_spawn_recovery_system.gd` are now complete).
