...
- [ ] Manager files: `m_vcam_manager.gd`, `m_run_coordinator_manager.gd`, `m_scene_manager.gd`, `m_scene_director_manager.gd`, `scripts/managers/helpers/u_vcam_collision_detector.gd`.
