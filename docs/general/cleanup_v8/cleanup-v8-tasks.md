...
- [ ] ECS system-helper files: remaining P2.1 bare-print sites in `scripts/ecs/systems/helpers/u_vcam_debug.gd`, `u_vcam_look_input.gd`, `u_vcam_look_spring.gd`.
