...
1. Task 14: Consolidate UI resources (`scripts/ui/resources/` -> `scripts/resources/ui/`)
...
| 3: Folder Restructure | 9-16 | In progress (Task 13 complete) |
