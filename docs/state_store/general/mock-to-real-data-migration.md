...
See `docs/state_store/redux-state-store-entity-coordination-pattern.md` for details.

## References

- **Audit Document**: `docs/state_store/mock-data-removal-plan.md`
- **Usage Guide**: `docs/state_store/redux-state-store-usage-guide.md`
- **Entity Coordination**: `docs/state_store/redux-state-store-entity-coordination-pattern.md`
- **PRD**: `docs/state_store/redux-state-store-prd.md` (Version 3.1)
