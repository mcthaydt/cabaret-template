...
**Current Phase:** Cleanup V5 Phase 10B Complete (Display Appliers)
...
### Immediate: Cleanup V5 Phase 10C

1. **Task 10C**: Confirm/revert flow for window changes
2. **Task 10D**: Settings UI polish (contextual enable/disable + focus clarity)
