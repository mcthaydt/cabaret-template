...
- **2026-03-06: Phase 5D/5E closure completed (manual + documentation)**
  ...
  - Updated documentation for final rollout state:
    ...
    - `docs/guides/pitfalls/` (theme tokens vs inline overrides, motion opt-in pitfall, semantic override exceptions)
...
3. Preserve the tokenized-theme + motion-resource contracts documented in `AGENTS.md` and `docs/guides/pitfalls/`.
...
| `docs/guides/pitfalls/` | 5C | New pitfalls |
