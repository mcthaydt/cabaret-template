...
**Current status (2026-04-29)**: Phases 1–4, 6–8 COMPLETE. Phase 5 not started (deferred to last). Phase 8 complete: P8.1–P8.12 all landed. Key P8.6–P8.12 commits: `738ba24a` (style enforcement, _localize_with_fallback extraction, builder fallback params, BaseSettingsSimpleOverlay consolidation, menu builder integration tests), `ef78818b` (ADR-0013 + extension recipe updates). Style suite 98/98. Full suite 4839/4839.
