...
- **Phase 4**: IN PROGRESS. P4.1 classification doc and P4.2 target structure doc are complete. P4.3 RED boundary test is complete; first GREEN move chunk moved demo gameplay/debug scripts into `scripts/demo/` and updated references. Remaining P4.3 chunks should continue moving demo ECS components/systems, demo AI resource scripts, then core scripts/resources/scenes/assets per `docs/history/cleanup_v8/target_structure.md`.
...
1. Continue Phase 4 P4.3 move commits; next logical chunk is demo ECS components/systems under `scripts/demo/ecs/**`.
