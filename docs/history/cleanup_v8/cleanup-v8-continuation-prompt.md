...
- **Phase 4**: IN PROGRESS. P4.1 classification doc and P4.2 target structure doc are complete. P4.3 RED boundary test is complete; two GREEN move chunks are complete: demo gameplay/debug scripts moved into `scripts/demo/` and demo ECS components/systems moved into `scripts/demo/ecs/**` (`df91cc4b`). Remaining P4.3 chunks should continue with demo AI resource scripts, then core scripts/resources/scenes/assets per `docs/history/cleanup_v8/target_structure.md`.
...
1. Continue Phase 4 P4.3 move commits; next logical chunk is demo AI resource scripts under `scripts/demo/resources/ai/**`.
