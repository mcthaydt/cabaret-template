...
- `docs/state store/architecture.md` - State flow diagrams
- `docs/state store/api-reference.md` - Public API documentation
- `docs/state store/workflows.md` - Common development workflows
