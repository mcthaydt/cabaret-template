...
func before_each() -> void:
	...
	# Create M_TimeManager (Phase 2: T024b - sole authority for pause/cursor) - register immediately
...
func test_settings_with_return_to_pause_using_new_api() -> void:
	...
	_scene_manager.push_overlay_with_return(StringName("settings_panel"))
	await get_tree().process_frame
