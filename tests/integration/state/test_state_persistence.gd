...
func test_gameplay_state_persists_across_state_handoff_transition() -> void:
	...
	var lc_after: String = String(StringName(g_after.get("last_checkpoint", StringName())))
	var lc_before: String = String(StringName(g_before.get("last_checkpoint", StringName())))
	assert_eq(lc_after, lc_before, "last_checkpoint should persist")
	var sp_after: String = String(StringName(g_after.get("target_spawn_point", StringName())))
	var sp_before: String = String(StringName(g_before.get("target_spawn_point", StringName())))
	assert_eq(sp_after, sp_before, "target_spawn_point should persist")
