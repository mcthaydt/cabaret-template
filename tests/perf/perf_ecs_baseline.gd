...
const S_INPUT := preload("res://scripts/core/ecs/systems/s_input_system.gd")
const S_MOVEMENT := preload("res://scripts/core/ecs/systems/s_movement_system.gd")
const S_JUMP := preload("res://scripts/core/ecs/systems/s_jump_system.gd")
const S_GRAVITY := preload("res://scripts/core/ecs/systems/s_gravity_system.gd")
const S_FLOATING := preload("res://scripts/core/ecs/systems/s_floating_system.gd")
const S_ROTATE := preload("res://scripts/core/ecs/systems/s_rotate_to_input_system.gd")
const S_ALIGN := preload("res://scripts/core/ecs/systems/s_align_with_surface_system.gd")
const S_LANDING := preload("res://scripts/core/ecs/systems/s_landing_indicator_system.gd")

const C_INPUT := preload("res://scripts/core/ecs/components/c_input_component.gd")
const C_MOVEMENT := preload("res://scripts/core/ecs/components/c_movement_component.gd")
const C_JUMP := preload("res://scripts/core/ecs/components/c_jump_component.gd")
const C_FLOATING := preload("res://scripts/core/ecs/components/c_floating_component.gd")
const C_ROTATE := preload("res://scripts/core/ecs/components/c_rotate_to_input_component.gd")
const C_ALIGN := preload("res://scripts/core/ecs/components/c_align_with_surface_component.gd")
const C_LANDING := preload("res://scripts/core/ecs/components/c_landing_indicator_component.gd")

const RS_MOVEMENT := preload("res://scripts/core/resources/ecs/rs_movement_settings.gd")
const RS_JUMP := preload("res://scripts/core/resources/ecs/rs_jump_settings.gd")
const RS_FLOATING := preload("res://scripts/core/resources/ecs/rs_floating_settings.gd")
const RS_ROTATE := preload("res://scripts/core/resources/ecs/rs_rotate_to_input_settings.gd")
const RS_ALIGN := preload("res://scripts/core/resources/ecs/rs_align_settings.gd")
const RS_LANDING := preload("res://scripts/core/resources/ecs/rs_landing_indicator_settings.gd")
