...
func test_set_effect_enabled_toggles_visibility() -> void:
	...
	_helper.set_effect_enabled(U_PostProcessLayer.EFFECT_GRAIN_DITHER, false)
...
func test_set_effect_parameter_sets_shader_uniform() -> void:
	...
	_helper.set_effect_parameter(U_PostProcessLayer.EFFECT_GRAIN_DITHER, StringName("fg_intensity"), 0.75)
