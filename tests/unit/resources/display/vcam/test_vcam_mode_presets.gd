...
const DEFAULT_ORBIT_PATH := "res://resources/core/display/vcam/cfg_default_orbit.tres"
const DEFAULT_RESPONSE_PATH := "res://resources/core/display/vcam/cfg_default_response.tres"
