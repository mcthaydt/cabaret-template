...
const EXPECTED_DEFAULT_GAMEPLAY_SCENE := StringName("ai_forest")
...
func test_play_button_dispatches_start_game_action() -> void:
	...
	assert_eq(nav_slice.get("base_scene_id"), EXPECTED_DEFAULT_GAMEPLAY_SCENE,
		"New Game button should target the ai_forest scene by default")
...
func test_new_game_confirmation_confirm_starts_game() -> void:
	...
	assert_eq(nav_slice.get("base_scene_id"), EXPECTED_DEFAULT_GAMEPLAY_SCENE,
		"Confirming New Game should target the ai_forest scene by default")
