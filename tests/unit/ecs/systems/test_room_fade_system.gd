...
func test_multi_target_group_applies_uniform_alpha_by_component() -> void:
	var fixture := _create_fixture()
	var system = fixture.get("system")
	var applier: RoomFadeMaterialApplierStub = fixture.get("applier") as RoomFadeMaterialApplierStub
	var ecs_manager: MockECSManager = fixture.get("ecs_manager") as MockECSManager
	...
	assert_almost_eq(front_alpha, back_alpha, 0.0001,
		"Room targets should share identical fade behavior within one group.")

func test_multi_target_group_fades_side_wall_with_front_wall_for_forward_looking_camera() -> void:
	var fixture := _create_fixture()
	var system = fixture.get("system")
	var applier: RoomFadeMaterialApplierStub = fixture.get("applier") as RoomFadeMaterialApplierStub
	var ecs_manager: MockECSManager = fixture.get("ecs_manager") as MockECSManager
	...
	assert_almost_eq(front_alpha, 0.05, 0.0001, "Front wall should fade for the active room.")
	assert_almost_eq(side_alpha, 0.05, 0.0001, "Side wall should match front-wall fade for the active room.")
...
func test_csg_group_applies_uniform_alpha_at_offset_from_world_origin() -> void:
	var fixture := _create_fixture()
	var system = fixture.get("system")
	var applier: RoomFadeMaterialApplierStub = fixture.get("applier") as RoomFadeMaterialApplierStub
	var ecs_manager: MockECSManager = fixture.get("ecs_manager") as MockECSManager
	...
	# With component-level fade, both walls should share the same alpha outcome.
	...
	assert_almost_eq(south_alpha, 0.05, 0.01, "South wall should match north wall alpha for group fade.")

func test_csg_group_applies_uniform_alpha_for_room_at_origin() -> void:
	var fixture := _create_fixture()
	var system = fixture.get("system")
	var applier: RoomFadeMaterialApplierStub = fixture.get("applier") as RoomFadeMaterialApplierStub
	var ecs_manager: MockECSManager = fixture.get("ecs_manager") as MockECSManager
