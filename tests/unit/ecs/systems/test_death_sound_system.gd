...
const DEATH_SOUND_SYSTEM := preload("res://scripts/core/ecs/systems/s_death_sound_system.gd")
const DEATH_SOUND_SETTINGS := preload("res://scripts/core/resources/ecs/rs_death_sound_settings.gd")
