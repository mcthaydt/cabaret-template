...
const LANDING_SOUND_SYSTEM := preload("res://scripts/core/ecs/systems/s_landing_sound_system.gd")
const LANDING_SOUND_SETTINGS := preload("res://scripts/core/resources/ecs/rs_landing_sound_settings.gd")
