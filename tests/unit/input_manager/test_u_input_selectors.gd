...
func test_is_aim_pressed_returns_flag() -> void:
	assert_true(U_InputSelectors.is_aim_pressed(SAMPLE_STATE))

func test_is_aim_pressed_defaults_to_false() -> void:
	assert_false(U_InputSelectors.is_aim_pressed({}))
