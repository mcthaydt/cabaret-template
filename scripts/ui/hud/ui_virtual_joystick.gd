...
const DEFAULT_BASE_TEXTURE_PATH := "res://assets/button_prompts/mobile/joystick_base.png"
const DEFAULT_THUMB_TEXTURE_PATH := "res://assets/button_prompts/mobile/joystick_thumb.png"
