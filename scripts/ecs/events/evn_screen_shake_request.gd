...
## Event requesting screen shake VFX effect.
##
## Published by: VFX publisher systems (S_ScreenShakePublisherSystem)
...
func _init(p_entity_id: StringName, p_trauma_amount: float, p_source: StringName = StringName("")) -> void:
