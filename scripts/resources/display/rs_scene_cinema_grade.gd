...
func to_dictionary() -> Dictionary:
	return {
		"color_grading_filter_mode": FILTER_PRESET_MAP.get(filter_preset, 0),
		"color_grading_filter_intensity": filter_intensity,
		"color_grading_exposure": exposure,
		"color_grading_brightness": brightness,
		"color_grading_contrast": contrast,
		"color_grading_brilliance": brilliance,
		"color_grading_highlights": highlights,
		"color_grading_shadows": shadows,
		"color_grading_saturation": saturation,
		"color_grading_vibrance": vibrance,
		"color_grading_warmth": warmth,
		"color_grading_tint": tint,
		"color_grading_sharpness": sharpness,
	}
