...
@export var preconditions: Array = []:
	...
	set(value):
		_preconditions = _sanitize_preconditions(value)
		_runtime_preconditions = _sanitize_runtime_preconditions(value)
...
@export var effects: Array = []:
	...
	set(value):
		...
		_runtime_effects = _sanitize_runtime_effects(value)
...
func _sanitize_preconditions(value: Variant) -> Array[I_Condition]:
...
func _sanitize_effects(value: Variant) -> Array[RS_WorldStateEffect]:
	var sanitized: Array[RS_WorldStateEffect] = []
	if not (value is Array):
		return sanitized
	for effect_variant in value as Array:
		if effect_variant is RS_WorldStateEffect:
			sanitized.append(effect_variant as RS_WorldStateEffect)
	return sanitized

func _sanitize_runtime_preconditions(value: Variant) -> Array[Object]:
...
func _sanitize_runtime_effects(value: Variant) -> Array[Object]:
	var sanitized: Array[Object] = []
	if not (value is Array):
		return sanitized
	for effect_variant in value as Array:
