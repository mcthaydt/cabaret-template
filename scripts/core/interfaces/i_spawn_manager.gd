...
func spawn_entity_at_point(_scene: Node, _entity_id: StringName, _spawn_point_id: StringName) -> bool:
	push_error("I_SpawnManager.spawn_entity_at_point not implemented")
	return false
