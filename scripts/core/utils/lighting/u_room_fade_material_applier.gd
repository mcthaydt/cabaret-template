...
const SH_ROOM_FADE := preload("res://assets/core/shaders/sh_room_fade.gdshader")
const SH_ROOM_FADE_DITHERED := preload("res://assets/core/shaders/sh_room_fade_dithered.gdshader")
