...
static func _register_scene_grades() -> void:
	...
	var alleyway := preload("res://resources/display/color_gradings/cfg_color_grading_alleyway.tres") as RS_SceneColorGrading
	var exterior := preload("res://resources/display/color_gradings/cfg_color_grading_exterior.tres") as RS_SceneColorGrading
	var bar := preload("res://resources/display/color_gradings/cfg_color_grading_bar.tres") as RS_SceneColorGrading
	var interior_house := preload("res://resources/display/color_gradings/cfg_color_grading_interior_house.tres") as RS_SceneColorGrading
