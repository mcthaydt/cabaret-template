...
const VICTORY_SCREEN := preload("res://resources/ui_screens/cfg_victory_screen.tres")
const CREDITS_SCREEN := preload("res://resources/ui_screens/cfg_credits_screen.tres")
const PAUSE_MENU_OVERLAY := preload("res://resources/ui_screens/cfg_pause_menu_overlay.tres")
const SETTINGS_MENU_OVERLAY := preload("res://resources/ui_screens/cfg_settings_menu_overlay.tres")
...
const VFX_SETTINGS_OVERLAY := preload("res://resources/ui_screens/cfg_vfx_settings_overlay.tres")
const DISPLAY_SETTINGS_OVERLAY := preload("res://resources/ui_screens/cfg_display_settings_overlay.tres")
const AUDIO_SETTINGS_OVERLAY := preload("res://resources/ui_screens/cfg_audio_settings_overlay.tres")
