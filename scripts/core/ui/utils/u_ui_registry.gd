...
const BASE_PANEL_SCRIPT := preload("res://scripts/core/ui/base/base_panel.gd")
const BASE_MENU_SCREEN_SCRIPT := preload("res://scripts/core/ui/base/base_menu_screen.gd")
const BASE_OVERLAY_SCRIPT := preload("res://scripts/core/ui/base/base_overlay.gd")
const UI_SAVE_LOAD_MENU_SCRIPT := preload("res://scripts/core/ui/overlays/ui_save_load_menu.gd")

# Preload all UI screen definitions (required for exported builds)
const MAIN_MENU_SCREEN := preload("res://resources/core/ui_screens/cfg_main_menu_screen.tres")
const GAME_OVER_SCREEN := preload("res://resources/core/ui_screens/cfg_game_over_screen.tres")
const VICTORY_SCREEN := preload("res://resources/core/ui_screens/cfg_victory_screen.tres")
const CREDITS_SCREEN := preload("res://resources/core/ui_screens/cfg_credits_screen.tres")
const PAUSE_MENU_OVERLAY := preload("res://resources/core/ui_screens/cfg_pause_menu_overlay.tres")
const SETTINGS_MENU_OVERLAY := preload("res://resources/core/ui_screens/cfg_settings_menu_overlay.tres")
const SAVE_LOAD_MENU_OVERLAY := preload("res://resources/core/ui_screens/cfg_save_load_menu_overlay.tres")
const INPUT_PROFILE_SELECTOR_OVERLAY := preload("res://resources/core/ui_screens/cfg_input_profile_selector_overlay.tres")
const GAMEPAD_SETTINGS_OVERLAY := preload("res://resources/core/ui_screens/cfg_gamepad_settings_overlay.tres")
const KEYBOARD_MOUSE_SETTINGS_OVERLAY := preload("res://resources/core/ui_screens/cfg_keyboard_mouse_settings_overlay.tres")
const TOUCHSCREEN_SETTINGS_OVERLAY := preload("res://resources/core/ui_screens/cfg_touchscreen_settings_overlay.tres")
const INPUT_REBINDING_OVERLAY := preload("res://resources/core/ui_screens/cfg_input_rebinding_overlay.tres")
const EDIT_TOUCH_CONTROLS_OVERLAY := preload("res://resources/core/ui_screens/cfg_edit_touch_controls_overlay.tres")
const VFX_SETTINGS_OVERLAY := preload("res://resources/core/ui_screens/cfg_vfx_settings_overlay.tres")
