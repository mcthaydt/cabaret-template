...
static func _initialize_registry() -> void:
	...
	var keyboard_base := "res://assets/core/button_prompts/keyboard/"
	var gamepad_base := "res://assets/core/button_prompts/gamepad/"

	var mobile_base := "res://assets/core/button_prompts/mobile/"
