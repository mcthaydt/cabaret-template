...
func _run() -> void:
	...
	builder.create_root("StaticBody3D", "E_WoodsStone")
	builder.add_csg_sphere("Mesh", 0.6, Color(0.55, 0.55, 0.55))
	builder.add_collision_box("CollisionShape3D", Vector3(1.5, 1, 1.5))
	builder.add_ecs_component_by_path(
		...
		{})
	builder.save("res://scenes/demo/prefabs/prefab_woods_stone.tscn")
