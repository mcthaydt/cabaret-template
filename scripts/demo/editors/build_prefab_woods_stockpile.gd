...
func _run() -> void:
	...
	builder.create_root("StaticBody3D", "E_WoodsStockpile")
	builder.add_csg_box("Mesh", Vector3(1.5, 0.5, 1.5), Color(0.6, 0.45, 0.25))
	builder.add_collision_box("CollisionShape3D", Vector3(2, 1, 2))
	builder.add_ecs_component_by_path(
		...
		{})
	builder.save("res://scenes/demo/prefabs/prefab_woods_stockpile.tscn")
