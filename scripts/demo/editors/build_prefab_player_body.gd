...
func _run() -> void:
	...
	direction.transform = Transform3D(Basis(Vector3(0.39169633, 0.0, 0.0), Vector3(0.0, 0.15378642, 0.0), Vector3(0.0, 0.0, 0.36884245)), Vector3(-0.019476414, 2.6623948, -0.4746977))
