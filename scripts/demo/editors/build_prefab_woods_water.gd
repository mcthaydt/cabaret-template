...
func _run() -> void:
	...
	builder
		.create_root("StaticBody3D", "E_WoodsWater")
		.add_csg_box("Mesh", Vector3(2, 0.15, 2), Color(0.2, 0.4, 0.8, 0.7))
		.add_collision_box("CollisionShape3D", Vector3(3, 0.3, 3))
		.add_ecs_component_by_path(
			...
			{})
		.save("res://scenes/demo/prefabs/prefab_woods_water.tscn")
